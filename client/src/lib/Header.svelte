...
>
    ...
    <div id="navigation" class="relative">
        ...
        <div
            ...
            class="bg-white dark:bg-black rounded border lg:border-0 border-neutral-500 px-2 py-4 min-w-48 absolute z-10 top-12 right-0 lg:static flex flex-col-reverse lg:flex-row items-center gap-y-6 gap-x-12"
        >
            ...
            <div id="user-options" class="w-full lg:w-auto">
                ...
                {:else}
                    <div id="user-verified" class="flex justify-center">
                        <div
                            id="user-pfp-container"
                            class="w-12 aspect-square h-auto rounded-full flex items-center overflow-hidden"
                        >
